...
class ProfCardBackFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<ImageView>(R.id.frame_img0).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout0).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 0
        }
        view.findViewById<ImageView>(R.id.frame_img1).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout1).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 1
        }
        view.findViewById<ImageView>(R.id.frame_img2).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout2).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 2
        }
        view.findViewById<ImageView>(R.id.frame_img3).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout3).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 3
        }
        view.findViewById<ImageView>(R.id.frame_img4).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout4).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 4
        }
        view.findViewById<ImageView>(R.id.frame_img5).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout5).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 5
        }
        view.findViewById<ImageView>(R.id.frame_img6).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout6).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 6
        }
        view.findViewById<ImageView>(R.id.frame_img7).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout7).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 7
        }
        view.findViewById<ImageView>(R.id.frame_img8).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout8).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 8
        }
        view.findViewById<ImageView>(R.id.frame_img9).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout9).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 9
        }
        view.findViewById<ImageView>(R.id.frame_img10).setOnClickListener{
            reset_color()
            view.findViewById<FrameLayout>(R.id.s_layout10).setBackgroundColor(Color.rgb(127, 0, 0))
            ma.profsave[1]= 10
        }
    }
